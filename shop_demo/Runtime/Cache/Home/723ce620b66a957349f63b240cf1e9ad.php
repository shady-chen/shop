    ...
    <div id="dialog" class="window">
        <div class="login">
            <div class="login_div">
                ...
                <form action="<?php echo ($smarty["const"]["/index.php/Home/Index/allNotice"]); ?>" method="post">
...
<nav id="menu" class="navbar">
	...
	<div class="row" style="margin-top:30px; color:black;">
		<div class="col-md-8" style="padding-left:100px;line-height: 30px;font-size: 18px;color:rgb(280,68,0)">公告列表</div>
	...
	<div class="container" style="margin-top:40px;margin-bottom:50px">
		<table border="1" class="table table-hover">
			...
			<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
				<td><a href="/index.php/Home/Index/notice/nc_id/<?php echo ($v['nc_id']); ?>"><?php echo ($v['nc_title']); ?></a></td>
