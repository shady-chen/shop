    ...
    <div id="dialog" class="window">
        <div class="login">
            <div class="login_div">
                ...
                <form action="<?php echo ($smarty["const"]["/index.php/Home/Goods/artile"]); ?>" method="post">
	...
	<div class="row">
				<div class="col-lg-12">
					<ul class="breadcrumb">
						...
						<li><a href="#" style="color:rgb(286,60,0)"><?php echo ($info['if_gd_name']); ?></a></li>
					</ul>
				</div>
			</div>
	<div class="row" style="border:1px dashed black;margin-bottom:30px;">
			<h3 align="center" style="color:rgb(286,60,0);font-family:楷体"><?php echo ($info['if_gd_name']); ?></h3>
			<h6 align="center" style="color:gray;font-family:楷体"><?php echo ($info['if_name']); ?> / <?php echo ($info['if_time']); ?></h6>
			<p style='line-height:30px;text-indent:46px;letter-spacing:2px;'><?php echo ($info['if_information']); ?></p>
	</div>
</div>
