			...
			<div class="row">
				...
				<div class="col-md-2">
					...
					<div class="col-md-8" style="float:right;padding-top:10px">
						<ul class="top-link">
							<li><span class="glyphicon glyphicon-user"></span></span><span style="color:black;" id="login"><?php echo ($username); ?></span></li>
							<li><a href="javascript:void(0)"><span class="glyphicon glyphicon-glass" style></span>注册</a></li>
							<li><a href="/index.php/Home/Goods/cart"><span class="glyphicon glyphicon-shopping-cart"></span>购物车</a></li>
							<li><a href="/index.php/Home/Goods/favorite"><span class="glyphicon glyphicon-star"></span>收藏夹</a></li>
							<li><a href="/index.php/Home/Index/userInfo"><span class="glyphicon glyphicon-user" style=></span> 个人管理</a></li>
	...
	<div id="dialog" class="window">
		<div class="login">
        	<div class="login_div">
                ...
                <form action="<?php echo ($smarty["const"]["/index.php/Home/User/register"]); ?>" method="post">
			...
			<div class="row">
				...
				<div class="col-md-6" style="margin-left:300px">
					<table class="table" id="register">
					  <form method="post" action="/index.php/Home/User/register" id="register" name="form" onsubmit="return checkForm()">
						<script>
