<?php /* Smarty version Smarty-3.1.6, created on 2017-12-27 20:58:09
         compiled from "D:/techan/shop_demo/Home/View\User\register.html" */ ?>
<?php /*%%SmartyHeaderCode:247195a4398e19fa335-59763207%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3e85e3a8f7f266cff721513f8590105b88eedfe1' => 
    array (
      0 => 'D:/techan/shop_demo/Home/View\\User\\register.html',
      1 => 1514293412,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '247195a4398e19fa335-59763207',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a4398e1b36d9',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4398e1b36d9')) {function content_5a4398e1b36d9($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
top.png" /></div>
					...
					<div class="col-md-8" style="float:right;padding-top:10px">
						<ul class="top-link">
							...
							<li><a href="javascript:void(0)"><span class="glyphicon glyphicon-glass" style></span>注册</a></li>
...
/userInfo"><span class="glyphicon glyphicon-user" style=></span> 个人管理</a></li>
							<li><a href="<?php echo @__MODULE__;?>
...
" method="post">
				...
				<span style="left:20px;color:red">还没有账号?<a href="#" style="color:red;">立即注册</a></span>
			...
			<div class="row">
				<div class="col-lg-12">
					<ul class="breadcrumb">
						...
						<li><a href="javascript:void(0)" style="color:rgb(280,68,0)">注册</a></li>
					</ul>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="heading"><h2 style="color:rgb(280,69,0);padding-left:200px">还没有账号? 快来注册属于你的专属账号吧</h2></div>
				</div>
				<div class="col-md-6" style="margin-left:300px">
					<table class="table" id="register">
					  <form method="post" action="<?php echo @__MODULE__;?>
/User/register" id="register" name="form" onsubmit="return checkForm()">
						<script>
					  	...
					  	<tr>
					  	  ...
					  	  <td>
								<input type="text" class="form-control" placeholder="请填写用户名" name="username" id="username" oninput="registUsername();" onblur="judge();" required>
		<script>
		function judge(){
			...
			xhr.send(null);
						...
						<tr>
							...
							<td>
								...
								<input type="password" class="form-control" placeholder="请填写密码" name="password" id="passwords"  required onKeyUp="pwStrength(this.value);" onBlur="pwStrength(this.value);">
						...
						<tr>
							...
							<td>
								<table cellspacing="0" class="regist-table">   
                                				<tr>
						...
						<tr>
							...
							<td>
								<input type="password" class="form-control" placeholder="请确认密码" id="passwordTwo" oninput="registPswordTwo();" required>
						...
						<tr>
							...
							<td>
								<input type="text" class="form-control" placeholder="请填写邮箱" name="email" id="email" oninput="registerEmail();" required> 
						...
						<tr>
							...
							<td>
								<input type="text" class="form-control" placeholder="请填写手机号" name="phone" id="phone" oninput="registerPhone();" required>
								<span id="phoneSpan"></span>
							</td>
						</tr>
						<tr>
							<td><label>验证问题</label></td>
							<td>
						...
						<tr>
							<td></td>
							<td>
								<input  type="radio" name="rValue">看过并接受
								<span style="color:rgb(280,68,0)">《田野间用户协议》</span>
							</td>
						</tr>
						<tr>
							<td colspan="2">
							<input type="submit" style="background:rgb(280,68,0);color:white;width:150px;height:40px;border-radius: 10px;margin-left:80px" value="创建">
