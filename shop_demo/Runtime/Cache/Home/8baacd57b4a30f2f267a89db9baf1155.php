				...
				<div class="col-md-2">
					...
					<div class="col-md-8" style="float:right;padding-top:10px">
						<ul class="top-link">
							...
							<li><a href="/index.php/Home/User/register"><span class="glyphicon glyphicon-glass" style></span>注册</a></li>
							<li><a href="/index.php/Home/Index/cart"><span class="glyphicon glyphicon-shopping-cart"></span>购物车</a></li>
							<li><a href="/index.php/Home/Index/favorite"><span class="glyphicon glyphicon-star"></span>收藏夹</a></li>
							 <li><a href="/index.php/Home/User/userInfo"><span class="glyphicon glyphicon-user" style=></span> 个人管理</a></li>
							<li><a href="/index.php/Home/Index/contact"><span class="glyphicon glyphicon-envelope"></span>联系我们</a></li>
	...
	<div id="dialog" class="window">
		<div class="login">
        	<div class="login_div">
                ...
                <form action="<?php echo ($smarty["const"]["/index.php/Home/Goods/goodstext"]); ?>" method="post">
...
function searchText(){
	...
	window.location.href = '<?php echo ($smarty["const"]["/index.php/Home/Goods/goodstext"]); ?>/search/'+info;
}
</script>
	<div class="container" style="margin-top:80px;margin-bottom:50px">
		<table border="1" class="table table-hover">
			...
			{foreach $info as $v}
			<tr>
				<td><a href="/index.php/Home/Index/artile/id/<?php echo ($v['if_id']); ?>"><?php echo ($v['if_gd_name']); ?></a></td>
				<td><?php echo ($v['if_name']); ?></td>
