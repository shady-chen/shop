    ...
    <div id="dialog" class="window">
        <div class="login">
            <div class="login_div">
                ...
                <form action="<?php echo ($smarty["const"]["/index.php/Home/Goods/favorite"]); ?>" method="post">
                ...
                <div id="main-content" class="col-md-8"> 
                        <div class="row">
                            ...
                            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="col-xs-4">
                                    <div class="product">
                                        <div class="image"><a href="product.html"><img src="<?php echo ($v['gd_img']); ?>" /></a></div>
                                        <div class="buttons">
                                            ...
                                            <a class="btn wishlist" href="/index.php/Home/Goods/favorite/delete/<?php echo ($v['gd_id']); ?>">
