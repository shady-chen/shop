    ...
    <div id="dialog" class="window">
        <div class="login">
            <div class="login_div">
                ...
                <form action="<?php echo ($smarty["const"]["/index.php/Home/Goods/contact"]); ?>" method="post">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6" style="margin-bottom: 30px;">
					<form name="form1" id="ff" method="post" action="?" onsubmit="return checks();">
	...
	function checks(){
		...
		if(email.innerHTML){
			...
			return true;
				...
				<div class="col-md-6">
					<p><span class="glyphicon glyphicon-home" style="color:rgb(255,68,0)"></span> 福建省龙岩市新罗区东肖镇龙岩学院一组六栋520</p>
					<p><span class="glyphicon glyphicon-earphone" style="color:rgb(255,68,0)"></span> +15880630261</p>
					<p><span class="glyphicon glyphicon-envelope" style="color:rgb(255,68,0)"></span> 15880630261@qq.com</p>
