    ...
    <div id="dialog" class="window">
        <div class="login">
            <div class="login_div">
                ...
                <form action="<?php echo ($smarty["const"]["/index.php/Home/Index/notice"]); ?>" method="post">
...
<div class="container">
	<div class="row">
				<div class="col-lg-12">
					<ul class="breadcrumb">
						<li><a href="/index.php">首页</a></li>
						<li><a href="/index.php/Home/Index/allNotice">公告列表</a></li>
						<li><a href="#" style="color:rgb(286,60,0)">公告信息</a></li>
					</ul>
				</div>
			</div>
	<div class="col-md-11">
