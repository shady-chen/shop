    ...
    <div id="dialog" class="window">
        <div class="login">
            <div class="login_div">
                ...
                <form action="<?php echo ($smarty["const"]["/index.php/Home/Goods/cart"]); ?>" method="post">
				...
				<div class="product well">
						<table class="table">
							...
							<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
								...
								<td scope="col"><input type="text" id="buy_num<?php echo ($i); ?>" value="<?php echo ($v['ct_buy_count']); ?>">
									<input type="hidden" id="gd_id<?php echo ($i); ?>" value="<?php echo ($v['gd_id']); ?>">
									<input type="hidden" id="gd_num<?php echo ($i); ?>" value="<?php echo ($v['gd_num']); ?>">
								</td>
								<td scope="col"><?php echo ($v['gd_num']); ?></td>
								<td scope="col"><?php echo ($v['gd_price_self']*$v['ct_buy_count']); ?></td>
								<td scope="col">
									<a class="btn btn-info" href="/index.php/Home/Goods/cart/act/delete/gd_id/<?php echo ($v['gd_id']); ?>">删除</a>
									<a class="btn btn-info" onclick="update(<?php echo ($i); ?>);">更改</a>
								</td>
			...
			<div class="row" id="order">
				 ...
				 <div class="col-xs-4">
                        <table>
                            ...
                            <tr>
                                <td colspan="2">
                                  <a href="/index.php/Home/Goods/goodslist" class="btn btn-1" style="background:rgb(280,68,0);color:white">继续购物</a>
                                 <a href="/index.php/Home/Goods/order" class="btn btn-1" style="background:rgb(280,68,0);color:white">提交订单</a>
                                 </td>
                            </tr>
                        </table>
                </div>
